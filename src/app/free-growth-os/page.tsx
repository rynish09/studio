                    ...
                    <Card className="bg-card border-border">
                        <CardHeader>
                            ...
                            <CardDescription className="text-lg text-white/70 pt-2">
                                To access the complete Growth OS, please provide your details below. This is the first step towards building your legacy.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                     ...
                     <div className="mt-20 max-w-4xl mx-auto">
                        <Card className="bg-card border-border">
                            <CardHeader>
                                ...
                                <CardDescription className="text-lg text-white/70 pt-2">
                                    Thank you! Your blueprint is unlocked. To take the next step and turn these insights into action, please select a time for your complimentary strategy call below.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
