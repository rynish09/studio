  ...
  return (
    <div className="container mx-auto py-24 sm:py-32">
      <PageHeader 
        ...
        subtitle="Success leaves clues. Our content agency deconstructs the playbooks of industry titans who turned organic marketing and class content into empires. Learn from the best."
      />
