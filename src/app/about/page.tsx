  ...
  return (
    <div className="container mx-auto py-24 sm:py-32">
      <PageHeader
        ...
        subtitle="We are a premier content agency dedicated to building defensible brand narratives for leaders and innovators. We don't chase algorithms; we cultivate authority, trust, and lasting enterprise value."
      />
      ...
      <AnimatedWrapper delay={200}>
        <section className="mt-24 max-w-4xl mx-auto">
            <div className="space-y-6 text-center">
                ...
                At The ConteX, we believe true influence is an outcome of generosity and expertise, systematically delivered. We distill complexity into clarity, codify success into repeatable systems, and execute with an obsessive focus on craft and class content.
                </p>
                <p className="text-white/80 text-lg" style={{ lineHeight: 1.7 }}>
            ...
            <div className="bg-card border-border rounded-lg p-8 md:p-12">
                <div className="relative text-center">
                    ...
                    <blockquote className="mt-6 max-w-4xl mx-auto">
                        ...
                        "The most valuable asset in the new economy isn't attention—it's authority. And the most effective way to build it is by generously sharing expertise so valuable, it would be a crime to charge for it."
                        </p>
                    </blockquote>
                    <p className="mt-4 text-sm text-muted-foreground">This is the philosophy our content agency applies to building legendary brands.</p>
                </div>
            </div>
        </section>
      </AnimatedWrapper>
